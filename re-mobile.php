	...
	<section class="section-compact">
		<div class="container">
			...
			<!-- <header class="heading-3 page-heading">
			  ...
			  <h4 class="text-center">Edit Mobile Number</h4>
			...
			<div class="form-main-container">
				<form class="checkout-form" method="POST" action="controller/re-mobile.php" autocomplete="off">
					<div class="row">
						<div class="col-sm-12 form-block">
							...
							<!--	<label class="col-md-12 label-md">Mobile number</label>  -->
								<div class="col-md-12">
									<input type="text" placeholder="Enter Mobile No Here"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" minlength="10" maxlength="10" class="form-control" required="" name="no" autocomplete="off" value="<?php echo $_GET['mobile']; ?>">
									<input type="hidden" name="oldmobile" value="<?php echo $_GET['mobile']; ?>">
								</div>
							</div>
                            ...
                            <div class="form-group row text-center">
							 <input type="submit" class="btn btn-default btn-block" name="mobile" value="Get Otp">
							</div>
