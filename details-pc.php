...
<div class="alert alert-info alert-dismissible alertpc" style="display: none;">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
  <strong>Your Product Successfully Added On Cart !</strong>
</div>
  ...
  <?php 
      ...
      if ($get_ship_amount=='0') {
      	 ...
      	 require_once('owner/autho/data-autho.php');
              ...
              $sqls_s = mysqli_query($con,"Select * from `shipping`"); 
              while($sqls_ss = mysqli_fetch_array($sqls_s)){  
                    $shipp=$sqls_ss['ship_amount'];
                }
             
      	 $get_ship = "INR $shipp.00 (All Over India)";
      }
 }   ?>
<?php
              require_once('owner/autho/data-autho.php');
...
$results = $mysqli->query("SELECT * FROM products where id='$id' order by id desc ");
...

{
	 if($obj->quantity >= 1)
	{
        ...
        $add="<input type='submit' class='btn btn-default  col-md-5 addcart' style='padding: 7px;' value='Add To Cart'></input>";
	}
	else{
   ...
   if(!empty($obj->offer))
	...
	// }
	// else{
 //       $price="<span  class='prod-price text-primary btn-details' data-id='57' data-toggle=modal' data-target='.bd-example-modal-xl' style='font-weight:bold;'><strong><big>Price : INR {$obj-> price }.00</big></strong></span>";
	// }
	...
	$products_item .= <<<EOT
				      ...
				      <div class="col-sm-7">
				        ...
				        <div class="text">
				          ...
				          <h4 style="text-transform: capitalize;">{$obj->brand} {$obj->product_name}</h4>
                           <br>
				          <h5>
                           $off_price
                            $price
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="comments-area">
	      ...
	      <div class="other-products" style="display: none;">
		        ...
		        <div class="item">
		          ...
		          <div class="thumbnail thumbnail-product">
		            ...
		            <div class="caption text-center">
		              ...
		              <h5><a href="details.php?id=<?php echo htmlspecialchars(ucwords($datas['id'])); ?>"><?php echo htmlspecialchars(ucwords($datas['product_name'])); ?></a></h5>
		              ...
		              <p class="prod-price text-primary">from Rs <?php echo htmlspecialchars(ucwords($datas['price'])); ?>.00</p>
