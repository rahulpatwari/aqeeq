					...
					<div class="row">
						<div class="col-md-offset-2 col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">Product Order List:</div>
								<div class="panel-body">
									<div class="alert icon-alert with-arrow alert-success form-alter" role="alert">
										<i class="fa fa-fw fa-check-circle"></i>
										<strong> Success ! </strong> <span class="success-message"> Product Order has been updated successfully </span>
									</div>
									...
									$query = mysqli_query($con, "SELECT * FROM products where sub = '$sub' ORDER BY serial_no +0 asc");
									...
									?>
										<li data-post-id="<?php echo $row["id"]; ?>">
											...
											<h5 class="li-post-title"><?php echo $row["serial_no"].') '.ucfirst($sub." ".$row['product_name']); ?></h5>
											<p class="li-post-desc"><img src="https://aqeeqtrading.com/product/<?php echo ucfirst($row["f_newfile"]); ?>" style="height: 50px; width:50px;"></p>
										</div>
										</li>
									<?php } 
									} ?>
