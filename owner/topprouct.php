      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="tile-body">
              <!-- Start Form Here -->
                  <form action="controller/add-scroller.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                    <label for="exampleInputEmail1">Upload Your Images Here</label>
                    <script>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              ...
              $s_no=1;
              $sqls = mysqli_query($con,"Select * from `scroller` order by id desc"); 
              while($datas = mysqli_fetch_array($sqls)){ ?>       
                   <tr>
                    <td><?php echo $s_no++; ?></td>
                    <td><img src="http://anandbazaar.in/images/<?php echo $datas['f_newfile']; ?>" height="100" width="100"></td>
                    <td><a href="controller/delete-scroller.php?id=<?php echo $datas['id']; ?>">Delete</a></td>
                  </tr>
                <?php } ?>  
                </tbody>
              </table>
