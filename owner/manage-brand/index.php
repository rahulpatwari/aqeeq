					...
					<div class="row">
						<div class="col-md-offset-2 col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading">Brand Order List:</div>
								<div class="panel-body">
									...
									<?php
									//get rows query
									$query = mysqli_query($con, "SELECT * FROM brand ORDER BY serial_no +0 asc");
									...
									?>
										<li data-post-id="<?php echo $row["id"]; ?>">
											...
											<h5 class="li-post-title"><?php echo $row["serial_no"].') '.ucfirst($row["brand_name"]); ?></h5>
